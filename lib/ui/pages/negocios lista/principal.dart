...
//   late List<Hoteles> hostal = [];
//   late List<Hoteles> habitacion = [];
//   late List<Hoteles> departamento = [];
//   late List<Hoteles> bungalow = [];

//   @override
//   void initState() {
//     super.initState();

//     PeticionesNegocio.listNegociosPrincipal("Hotel").then((value) {
//       setState(() {
//         hoteles = value;
//         // print(value.length);
//       });
...
//     PeticionesNegocio.listNegociosPrincipal("Hostal").then((value) {
//       setState(() {
//         hostal = value;
//         // print(value.length);
//       });
...
//     PeticionesNegocio.listNegociosPrincipal("Habitacion").then((value) {
//       setState(() {
//         habitacion = value;
//         // print(value.length);
//       });
...
//     PeticionesNegocio.listNegociosPrincipal("Departamento").then((value) {
//       setState(() {
//         departamento = value;
//         // print(value.length);
//       });
...
//     PeticionesNegocio.listNegociosPrincipal("Bungalow").then((value) {
//       setState(() {
//         bungalow = value;
//         // print(value.length);
//       });
